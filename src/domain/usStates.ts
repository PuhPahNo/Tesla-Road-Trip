/** Canonical US state/territory code → full name (matches the choropleth GeoJSON `properties.name`). */
...
/** Full name → state code (for matching GeoJSON features to our coverage data). */
