...
- Optimizer returns five candidate route plans with day-level stats.
...
10. Switch through all five route candidates.
...
- Close stations are assumed to allow short stop sessions because Tesla's referenced contest terms do not publish a minimum charging duration.
